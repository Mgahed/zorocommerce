                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                ...
                                <form method="post" action="{{ route('user.coupon.update',$coupons->id) }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <h5>{{__('User')}} <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input disabled type="email" class="form-control" style="cursor: not-allowed;"
                                                   value="{{ $coupons->user->email }}">
                                            @error('email')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
