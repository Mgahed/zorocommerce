                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($coupons as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('price.coupon.edit',$item->id) }}" class="btn btn-info"
                                                   title="Edit Data"><i class="fa fa-pencil"></i> </a>
                                                <a href="{{ route('price.coupon.delete',$item->id) }}"
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                ...
                                <form method="post" action="{{ route('price.coupon.store') }}">
                                    @csrf
